...
def process_wgov(data):
    ...
    for i in rng:
        ...
        if file_name.startswith("wgovDualImage.php"):
            ...
            bmp1 = Image.open(common.CACHEBASE + "/" + fimg).convert("RGBA")

            if fimg != simg:
                bmp2 = Image.open(common.CACHEBASE + "/" + simg).convert("RGBA")
            ...
            if match is not None:
                ...
                bmp1 = Image.open(common.CACHEBASE + "/" + file_name).convert("RGBA")
